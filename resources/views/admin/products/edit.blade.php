                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ url('/admin/products/edit/' . base64_encode($product->id)) }}" method="post" id="frmProduct" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" name="product_name" class="form-control" id="product_name" placeholder="e.g Toyota" value="{{ $product->product_name }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="product_color" class="col-sm-3 text-right control-label col-form-label">Product Color</label>
                                                <div class="col-sm-5">
                                                    <input type="text" name="product_color" class="form-control" id="product_color" placeholder="e.g Gold" value="{{ $product->product_color }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="product_code" class="col-sm-3 text-right control-label col-form-label">Product Code</label>
                                                <div class="col-sm-5">
                                                    <input type="text" name="product_code" class="form-control" id="product_code" placeholder="e.g PRD" value="{{ $product->product_code }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" name="product_price" class="form-control" id="product_price" placeholder="0.00"  value="{{ $product->product_price }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="product_image" class="col-sm-3 text-right control-label col-form-label">Product Image</label>
                                                <div class="col-sm-5">
                                                    <input type="file" name="product_image" class="form-control" id="product_image" placeholder="Image url here"  value="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="radio" name="status" class="text-left" value="1" {{ $product->status == 1 ? 'checked' : '' }}/> 
                                                    <label>Enable</label>
                                                    <p><input type="radio" name="status" class="text-left" value="0" {{ $product->status == 0 ? 'checked' : '' }}/> 
                                                    <label>Disable</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <?php if (!empty($product->product_image)) {?>
                                                <img src="/images/backend_img/products/small/{{ $product->product_image }}">
                                                <p><br/>
                                            <?php }?>

                                            <?php if (!empty($product->product_image) && $product->product_image != 'noimage.jpg') {?>
                                                <!-- Delete product image link -->
                                                <a href="#deleteImageModal{{ $product->id }}" class="btn btn-danger btn-sm" data-toggle="modal"><i class="fa fa-trash" data-toggle="tooltip" title="Delete image for {{ $product->product_name }}"></i> Delete</a>

                                                <!-- Delete Image Modal HTML -->
                                                @include('admin.products.modals.productImageModalDelete')
                                            <?php }?>
                                        </div>
                                    </div>
                                </div>
